...
public final class Constants {
    ...
    public static final int indexingButton_JoyDriving_5 = 5;
    public static final int shootingButton_JoyDriving_6 = 6;
    public static final int shootingFarawayButton_JoyDriving_7 = 7;
